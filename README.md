...
The primary showcase uses [`docs/shinku02.jpg`](docs/shinku02.jpg) as one shared source, so differences
...
<p align="center">
  <img src="docs/atri1.png" width="47%" alt="Wide-format source artwork for the EdgeGlyph bead example">
