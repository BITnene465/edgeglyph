...
from .engine import RenderConfig, draw_preview, render, write_debug, write_lua, write_text


def build_parser():
    parser = argparse.ArgumentParser(
        prog="edgeglyph",
        description="Convert images to structure-aware, font-matched glyph art.",
    )
    parser.add_argument("source", type=Path)
    parser.add_argument("--font", type=Path, required=True, help="Primary monospace TTF/OTF font")
    parser.add_argument("--fallback-font", type=Path, help="Font used for Unicode line symbols")
    ...
    parser.add_argument("--fill-mode", choices=("none", "salient", "tone"), default="none")
    ...
    parser.add_argument("--lua-output", type=Path, help="Write NvDash-compatible Lua data")
    parser.add_argument("--preview", type=Path, help="Write a color PNG preview")
    parser.add_argument("--debug-dir", type=Path, help="Write edge and mask diagnostics")
